...
##Running webdriver
    ...
    while len(apartments) < num_apartments:
        ...
        for apartment_list in apartment_list:
            ...
            while not collected_successfully:
                try:       
                    ...
                    try:
                        salary_estimate = property_rules = driver.find_element_by_xpath('.//div[@class="property-rules__collapsible__description"]').text
            ...
            if verbose:
                ...
                print("property_rules: {}".format(property_rules[:1000]))
                print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        ...
        try:
            driver.find_element_by_xpath('.//div[@class="paginator"]').click()
        except NoSuchElementException:
